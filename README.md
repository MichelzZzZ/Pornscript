...
an esoteric programming language. but unlike the popular ones. Pornscript is not designed to make programming harder. it is designed to be dirty. The langugage uses dirty keywords instead of the regular ones. It's still in it's early steps and needs a lot to work on.
